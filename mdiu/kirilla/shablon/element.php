<?
  $dim=" <img src='images/logo.png' >";


     //$dim=" <img src='assets/logo.png' >";
 $nav_shapka_foother = array (
  array('ГЛАВНАЯ','http://www.tavis.com.ua'),
  array('ТЕРМОДРЕВЕСИНА','termodrevesina.php'),
  array('ОБОРУДОВАНИЕ','http://www.tavis.com.ua/equipment/'),
  array('УСЛУГИ','http://www.tavis.com.ua/uslugi/'),
  array('О НАС','http://www.tavis.com.ua/about/'),
  array('КОНТАКТЫ','http://www.tavis.com.ua/kontakty/'),
);        
...
$nav_content = array(
 ...
 //  foreach ($nav_shapka_foother as $key => $value) {
 //     $menu .= "<li><a class =' linya' href='$value[1]'>$value[0]</a></li>";
 //  }
 //  $menu .= "<li class='dropdown'> ";
 //  $menu .= " <a href='#' class='dropdown-toggle' data-toggle='dropdown'>Другая продукция  <span class='glyphicon glyphicon-menu-down'></span></a>
...
require_once("shablon/shablon.html");
